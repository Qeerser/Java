...
public class ChangeColorCardTest {
    ...
    void testPerformEffectHasColor() {
        ...
        assertEquals(CardColor.BLUE, gameInstance.getTopCard().getColor());
        assertEquals(CardSymbol.CHANGE_COLOR, gameInstance.getTopCard().getSymbol());
    }
    ...
    void testPerformEffectNoColor() {
        ...
        assertEquals(CardColor.RED, gameInstance.getTopCard().getColor());
        assertEquals(CardSymbol.CHANGE_COLOR, gameInstance.getTopCard().getSymbol());
